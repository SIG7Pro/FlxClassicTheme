...
class FlxTypedButton<T:FlxSprite> extends FlxSprite implements IFlxInput
{
	...
	{
		// loadGraphic("flixel/images/ui/button.png", true, 80, 20); // yum // This was the original code for spawning the buttons. It wouldn't work on this unless you'd put the buttons outside of the assets folder. Its due to how Haxelibs handle assets if I'm not mistaken.
